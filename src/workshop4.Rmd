...
Vik teaches R in his classes at NUS , and presented his R packages at useR! 2014 ([popKorn](http://user2014.stat.ucla.edu/abstracts/talks/122_Gopal.pdf): An R package for inference on selected populations) and useR! 2013 ([kPop](http://www.edii.uclm.es/~useR-2013/abstracts/files/37_selPop.pdf): An R package for the interval estimation of the mean of the selected populations).
