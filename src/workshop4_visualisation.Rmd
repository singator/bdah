...
![RStudio Install Screen](img/rstudio_installa.png)

## Navigating RStudio

![RStudio Panels](img/rstudio_panelsa.png "RStudio Panels")
...
y <- c(2,4)
```
```{r echo=FALSE, fig.height=4, fig.path='img/'}
...
![Blank shiny](img/bdah_demo_1.png)
