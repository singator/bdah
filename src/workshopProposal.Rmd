...
2. To assist in achieving the primary objective, the presenters will share all our `R` code on GitHub before the workshop itself. We trust that this apporach will help overcome the initial barriers to using or switching to `R`. By studying and modifying our code, the attendees will be able to carry out similar analyses on their own datasets almost immediately.
